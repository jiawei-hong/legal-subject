<template>
    <div class="container">
        <router-link class="btn btn-primary btn-block mt-2" to="/YearSetting">返回學年度設置</router-link>
...
export default {
    ...
    methods: {
        ...
        downloadXlsx() {
            axios.get(`/api/xlsx/${this.$route.params.id}`, {
                headers: {
